...
!(function() {
  ...
  function n(e, t) {
    ...
    if (
      ...
      if (
        (s
          ...
          : (a =
              t[n.length + 1] === '/'
                ? n !== 'file:'
                  ? (a = t.substr(n.length + 2)).substr(a.indexOf('/') + 1)
                  : t.substr(8)
                : t.substr(n.length + 1)),
        o === '/')
      ) {
      ...
      for (
        var u = a.substr(0, a.lastIndexOf('/') + 1) + e, l = [], c = -1, f = 0;
        f < u.length;
        f++
      )
        if (c === -1)
      ...
      return c !== -1 && l.push(u.substr(c)), t.substr(0, t.length - a.length) + l.join('')
    }
    return e.indexOf(':') !== -1
      ? it && e[1] === ':' && e[2] === '\\' && e[0].match(/[a-z]/i)
        ? 'file:///' + e.replace(/\\/g, '/')
        : e
      : void 0
  }
  ...
  function f() {
    ...
    var t = {}
    ;(this[yt] = { lastRegister: void 0, records: t }), (this.trace = !1)
  }
  function d(e, t, r) {
    return (e.records[t] = {
      key: t,
  ...
  function p(e, t, r, n, o) {
    ...
    return a && !a.module
      ? a.loadError
        ...
        : h(e, a, a.linkRecord, n, o)
      : e.resolve(t, r).then(function(t) {
          if ((i = n[t])) return i
          if (
            (((a = o.records[t]) && !a.module) || (a = d(o, t, a && a.registration)), a.loadError)
          )
  ...
  function h(e, r, n, o, i) {
    return (
      ...
      (n.instantiatePromise = (r.registration
        ? Promise.resolve()
        ...
        .then(function(t) {
          ...
          return (
            ...
            (n.moduleObj = {}),
            a[2]
              ? ((n.moduleObj.default = n.moduleObj.__useDefault = {}),
                (n.executingRequire = a[1]),
                (n.execute = a[2]))
              : y(e, r, n, a[1]),
            r
          )
        ...
        .catch(function(e) {
          throw ((r.linkRecord = void 0),
          (r.loadError = r.loadError || t(e, 'Instantiating ' + r.key)))
        }))
    )
  }
  ...
  function y(e, t, r, n) {
    ...
    var s = n.call(
      ...
      function(e, t) {
        if (typeof e === 'object') {
          var r = !1
          for (var n in e)
            (t = e[n]), n === '__useDefault' || (n in o && o[n] === t) || ((r = !0), (o[n] = t))
          if (!1 === r) return t
        } else {
    ...
    ;(r.setters = s.setters),
      (r.execute = s.execute),
      s.exports && ((r.moduleObj = o = s.exports), (a = !0))
  }
  ...
  function w(e, t, r, n, o) {
    return new Promise(function(r, i) {
      function a(t) {
        var r = t.linkRecord
        r && u.indexOf(t) === -1 && (u.push(t), c++, b(e, t, r, n, o).then(s, i))
      }
      function s(e) {
        c--
        var t = e.linkRecord
  ...
  function k(e, t, r, n, o, i) {
    ...
    if (i && i.indexOf(t) !== -1) return t.linkRecord.moduleObj
    ...
    return function(s) {
      for (var u = 0; u < r.length; u++)
        if (r[u] === s) {
          ...
          var f = n[u]
          return (
            (c = f instanceof l ? f : k(e, f, f.linkRecord, o, i, a)),
            '__useDefault' in c ? c.__useDefault : c
          )
        }
      throw new Error(
        'Module ' + s + ' not declared as a System.registerDynamic dependency of ' + t
      )
    }
  }
  function O(e, r, n, o, i, a) {
    ...
    if (n.setters)
      for (var u, c, f = 0; f < n.dependencies.length; f++)
        if (
          !((u = n.dependencyInstantiations[f]) instanceof l) &&
          ((c = u.linkRecord) &&
            a.indexOf(u) === -1 &&
            (s = u.evalError ? u.evalError : O(e, u, c, o, i, c.setters ? a : [])),
          s)
        )
          return (r.linkRecord = void 0), (r.evalError = t(s, 'Evaluating ' + r.key)), r.evalError
    if (n.execute)
      if (n.setters) s = S(n.execute)
      else {
        var d = { id: r.key }
        var p = n.moduleObj
        ...
        ;(s = j(n.execute, g, p.default, d)),
          d.exports !== p.__useDefault && (p.default = p.__useDefault = d.exports)
        var h = p.default
    ...
    if (((o[r.key] = r.module = new l(n.moduleObj)), !n.setters)) {
      if (r.importerSetters)
        for (f = 0; f < r.importerSetters.length; f++) r.importerSetters[f](r.module)
  ...
  function M(e) {
    return (
      void 0 === xt && (xt = typeof Symbol !== 'undefined' && !!Symbol.toStringTag),
      e instanceof l || (xt && Object.prototype.toString.call(e) == '[object Module]')
    )
  }
  function R(e, t) {
    ;(t || (this.warnings && typeof console !== 'undefined' && console.warn)) && console.warn(e)
  }
  function C(e, t, r) {
    var n = new Uint8Array(t)
    return n[0] === 0 && n[1] === 97 && n[2] === 115
  ...
  function L(e, t) {
    ...
    if (!kt) {
      ...
      var n = decodeURI(t.substr(at ? 8 : 7))
  ...
  function F(e, t, r) {
    for (var n in t)
      if (Object.hasOwnProperty.call(t, n)) {
        ...
        void 0 === e[n]
          ? (e[n] = o)
          : o instanceof Array && e[n] instanceof Array
          ? (e[n] = [].concat(r ? o : e[n]).concat(r ? e[n] : o))
          : typeof o === 'object' && o !== null && typeof e[n] === 'object'
          ? (e[n] = (r ? I : A)(A({}, e[n]), o))
          : r || (e[n] = o)
      }
  }
  ...
  function U(e, t, r, n, o) {
    ...
    function s() {
      ...
      u.removeEventListener('load', i, !1),
        u.removeEventListener('error', a, !1),
  ...
  function J(e, t, r, n) {
    ...
    return (
      r && (o.integrity = r),
      t && (typeof t === 'string' && (o.headers.Authorization = t), (o.credentials = 'include')),
    ...
    return new Promise(function(r, o) {
      ...
      function a() {
        o(
          new Error(
            'XHR error: ' +
              (s.status ? ' (' + s.status + (s.statusText ? ' ' + s.statusText : '') + ')' : '') +
              ' loading ' +
              e
          )
        )
      ...
      n && (s.responseType = 'arraybuffer'),
        (s.onreadystatechange = function() {
          s.readyState === 4 &&
            (s.status == 0
              ? s.response
                ? i()
                : (s.addEventListener('error', a), s.addEventListener('load', i))
              : s.status === 200
              ? i()
              : a())
        }),
        ...
        s.setRequestHeader &&
          ...
          t &&
            (typeof t === 'string' && s.setRequestHeader('Authorization', t),
            (s.withCredentials = !0))),
        s.send(null)
    })
  }
  function B(e, t, r, n) {
    return e.substr(0, 8) != 'file:///'
      ? Promise.reject(
          new Error(
            'Unable to fetch "' +
              e +
              '". Only file URLs of the form file:/// supported running in Node.'
          )
        )
      : ((Lt = Lt || require('fs')),
        (e = at ? e.replace(/\//g, '\\').substr(8) : e.substr(7)),
  ...
  function H(e, t, r) {
    ...
    if (r) {
      var o
      t.pluginFirst
        ? (o = r.lastIndexOf('!')) !== -1 && (n.pluginArgument = n.pluginKey = r.substr(0, o))
        : (o = r.indexOf('!')) !== -1 && (n.pluginArgument = n.pluginKey = r.substr(o + 1)),
        (n.packageKey = N(t.packages, r)),
        n.packageKey && (n.packageConfig = t.packages[n.packageKey])
    }
    return n
  }
  function Z(e, t) {
    ...
    return Promise.resolve()
      .then(function() {
        var r = e.lastIndexOf('#?')
        if (r === -1) return Promise.resolve(e)
      ...
      .then(function(e) {
        ...
        return a
          ? ((n.pluginKey = a.plugin),
            Promise.all([
              ee.call(i, r, a.argument, (o && o.pluginArgument) || t, n, o, !0),
              i.resolve(a.plugin, t)
            ]).then(function(e) {
              if (
                ((n.pluginArgument = e[0]), (n.pluginKey = e[1]), n.pluginArgument === n.pluginKey)
              )
                throw new Error(
                  'Plugin ' +
                    n.pluginArgument +
  ...
  function Y(e, t) {
    ...
    var n = G()
    var o = o || H(this, r, t)
    var i = ne(r.pluginFirst, e)
    return i
      ? ((n.pluginKey = Y.call(this, i.plugin, t)),
        oe(
          r.pluginFirst,
          V.call(this, r, i.argument, o.pluginArgument || t, n, o, !!n.pluginKey),
          n.pluginKey
        ))
      : V.call(this, r, e, o.pluginArgument || t, n, o, !!n.pluginKey)
  }
  function Q(e, t, r, o, i) {
    ...
    if (t.substr(0, 6) === '@node/') return t
    var u = i && t[t.length - 1] !== '/'
    var l = T(e.baseURL, e.paths, u ? t + '/' : t)
  ...
  function V(e, t, r, n, o, i) {
    ...
    if (e.packageConfigKeys.indexOf(l) !== -1) return (n.packageKey = void 0), l
  ...
  function ee(e, t, r, n, o, i) {
    ...
    return Et.then(function() {
      ...
      var u = de(e, s)
      return (
        (n.packageKey = (u && u.packageKey) || N(e.packages, s)),
        n.packageKey
          ? e.packageConfigKeys.indexOf(s) !== -1
            ? ((n.packageKey = void 0),
              (n.load = te()),
              (n.load.format = 'json'),
              (n.load.loader = ''),
  ...
  function re(e, t, r) {
    ...
    for (var i in e.meta)
      if (
        (n = i.indexOf('*')) !== -1 &&
        i.substr(0, n) === t.substr(0, n) &&
        i.substr(n + 1) === t.substr(t.length - i.length + n + 1)
      ) {
    ...
    if ((e.meta[t] && F(r.load, e.meta[t], !1), r.packageKey)) {
      ...
      !r.packageConfig.format ||
        r.pluginKey ||
        r.load.loader ||
        (r.load.format = r.load.format || r.packageConfig.format)
    }
  }
  function ne(e, t) {
    var r
    var n
    var o = e ? t.indexOf('!') : t.lastIndexOf('!')
    if (o !== -1)
      return (
        e
          ? ((r = t.substr(o + 1)), (n = t.substr(0, o)))
          : ((r = t.substr(0, o)), (n = t.substr(o + 1) || r.substr(r.lastIndexOf('.') + 1))),
        { argument: r, plugin: n }
      )
  }
  function oe(e, t, r) {
  ...
  function ie(e, t, r, n, o) {
    ...
    if (
      (t.meta &&
        ge(t.meta, n, function(e, t, r) {
          if (r === 0 || e.lastIndexOf('*') !== e.length - 1) return (i = !0)
        }),
      !i &&
        e.meta &&
        ge(e.meta, r + '/' + n, function(e, t, r) {
          if (r === 0 || e.lastIndexOf('*') !== e.length - 1) return (i = !0)
        }),
      i)
    )
  ...
  function ue(e, t, r, n, o, i, a, s) {
    ...
    if (typeof u === 'object')
      throw new Error(
        'Synchronous conditional normalization not supported sync normalizing ' + o + ' in ' + n
      )
    if (se(o, u, i) && typeof u === 'string')
  ...
  function le(e, t, r, n, o, i, a) {
    ...
    return (
      r.map &&
        ((s = './' + o),
        (u = N(r.map, s)) || ((s = './' + ie(t, r, n, o, a)) !== './' + o && (u = N(r.map, s)))),
  ...
  function ce(e, t, r, n, o, i, a, s) {
    ...
    if (typeof u === 'string')
      return se(o, u, i)
        ? ee.call(e, t, u + i.substr(o.length), n + '/', a, a, s).then(function(t) {
    ...
    return Promise.all(l)
      .then(function(e) {
        for (var t = 0; t < c.length; t++) {
          var r = c[t].condition
          var n = q(r.prop, '__useDefault' in e[t] ? e[t].__useDefault : e[t])
      ...
      .then(function(r) {
        if (r)
          return se(o, r, i)
            ? ee.call(e, t, r + i.substr(o.length), n + '/', a, a, s).then(function(t) {
                return ve.call(e, t, n + '/', a)
              })
            : Et
      })
  ...
  function fe(e) {
    var t = e.lastIndexOf('*')
    var r = Math.max(t + 1, e.lastIndexOf('/'))
    return {
      length: r,
      regEx: new RegExp(
        '^(' +
  ...
  function de(e, t) {
    for (var r, n, o = !1, i = 0; i < e.packageConfigPaths.length; i++) {
      ...
      var s = Dt[a] || (Dt[a] = fe(a))
      if (!(t.length < s.length)) {
        var u = t.match(s.regEx)
        !u ||
          (r && ((o && s.wildcard) || !(r.length < u[1].length))) ||
          ((r = u[1]), (o = !s.wildcard), (n = r + a.substr(s.length)))
      }
    }
  ...
  function pe(e, r, n, o, i) {
    ...
    return (
      r.packageConfigKeys.indexOf(n) === -1 && r.packageConfigKeys.push(n),
      a
        .import(n)
        .then(function(e) {
  ...
  function ge(e, t, r) {
    ...
    for (var o in e) {
      ...
      if (
        (i && (o = o.substr(2)),
        (n = o.indexOf('*')) !== -1 &&
          o.substr(0, n) === t.substr(0, n) &&
          o.substr(n + 1) === t.substr(t.length - o.length + n + 1) &&
          r(o, e[i + o], o.split('/').length))
      )
        return
    }
  ...
  function we(e, t) {
    var r = e[t]
    return r instanceof Array ? e[t].concat([]) : typeof r === 'object' ? be(r, 3) : e[t]
  }
  function xe(e) {
    if (e) {
      if (Or.indexOf(e) !== -1) return we(this[St], e)
      throw new Error(
        '"' + e + '" is not a valid configuration name. Must be one of ' + Or.join(', ') + '.'
      )
    }
  ...
  function ke(e, t) {
    ...
    var o = this[St]
    if (
      ('warnings' in e && (o.warnings = e.warnings),
      'wasm' in e && (o.wasm = typeof WebAssembly !== 'undefined' && e.wasm),
      ('production' in e || 'build' in e) &&
        tt.call(r, !!e.production, !!(e.build || (Er && Er.build))),
      !t)
    ) {
      var i
      ye(r, e, function(e) {
    ...
    if (
      ...
      typeof e.pluginFirst === 'boolean' && (o.pluginFirst = e.pluginFirst),
      e.map)
    )
      for (var a in e.map) {
        var s = e.map[a]
        if (typeof s === 'string') {
          ...
          m = (m = Q.call(r, o, a[a.length - 1] !== '/' ? a + '/' : a, void 0, !0, !0)).substr(
            0,
            m.length - 1
          )
          var l = o.packages[m]
    ...
    if (e.packageConfigPaths) {
      for (var c = [], f = 0; f < e.packageConfigPaths.length; f++) {
        ...
        var p = Math.max(d.lastIndexOf('*') + 1, d.lastIndexOf('/'))
        var g = Q.call(r, o, d.substr(0, p), void 0, !1, !1)
        c[f] = g + d.substr(p)
      }
    ...
    if (e.packages)
      for (var a in e.packages) {
        ...
        ;(m = m.substr(0, m.length - 1)),
          Oe((o.packages[m] = o.packages[m] || Ee()), e.packages[a], m, !1, o)
      }
    if (e.depCache)
      for (var a in e.depCache) o.depCache[r.normalizeSync(a)] = [].concat(e.depCache[a])
    if (e.meta)
      for (var a in e.meta)
        if (a[0] === '*') A((o.meta[a] = o.meta[a] || {}), e.meta[a])
        else {
          var v = Q.call(r, o, a, void 0, !0, !0)
          A((o.meta[v] = o.meta[v] || {}), e.meta[a])
        }
    'transpiler' in e && (o.transpiler = e.transpiler)
    for (var y in e) Or.indexOf(y) === -1 && Tt.indexOf(y) === -1 && (r[y] = e[y])
    ye(r, e, function(e) {
      r.config(e, !0)
    })
  }
  ...
  function Oe(e, t, r, n, o) {
    for (var i in t)
      i === 'main' || i === 'format' || i === 'defaultExtension' || i === 'configured'
        ? (n && void 0 !== e[i]) || (e[i] = t[i])
        : i === 'map'
        ? (n ? I : A)((e.map = e.map || {}), t.map)
        : i === 'meta'
        ? (n ? I : A)((e.meta = e.meta || {}), t.meta)
        : Object.hasOwnProperty.call(t, i) &&
          R.call(o, '"' + i + '" is not a valid package configuration option in package ' + r)
    return (
      void 0 === e.defaultExtension && (e.defaultExtension = 'js'),
      void 0 === e.main && e.map && e.map['.']
        ? ((e.main = e.map['.']), delete e.map['.'])
        : typeof e.main === 'object' &&
          ((e.map = e.map || {}),
          (e.map['./@main'] = e.main),
  ...
  function Se(e) {
    return zt
      ? Wt + new Buffer(e).toString('base64')
      : typeof btoa !== 'undefined'
      ? Wt + btoa(unescape(encodeURIComponent(e)))
      : ''
  }
  function je(e, t, r, n) {
    var o = e.lastIndexOf('\n')
  ...
  function Pe(e) {
    Gt++ == 0 && (Bt = st.System), (st.System = st.SystemJS = e)
  }
  function Me() {
    --Gt == 0 && (st.System = st.SystemJS = Bt)
  }
    ...
    if (t) {
      ...
      try {
        Pe(e),
          !Jt &&
            e._nodeRequire &&
            ((Jt = e._nodeRequire('vm')),
            ($t = Jt.runInThisContext('typeof System !== \'undefined\' && System') === e)),
          $t
            ? Jt.runInThisContext(je(t, r, n, !a), { filename: n + (r ? '!transpiled' : '') })
            : (0, eval)(je(t, r, n, !a)),
          Me()
      } catch (e) {
        return Me(), e
  ...
  function Ae(e) {
    var t
    var r = e.lastIndexOf('!')
    var n = (t = r !== -1 ? e.substr(0, r) : e).split('/')
    return n.pop(), (n = n.join('/')), { filename: Ce(t), dirname: Ce(n) }
  }
  function Ie(e) {
    function t(e, t) {
  ...
  function Ke(e) {
    if (typeof e === 'string') return q(e, st)
  ...
  function De(e, t, r, n) {
    ...
    return (
      t ||
        ((Yt = {}),
        Object.keys(st).forEach(Fe, function(e, t) {
          Yt[e] = t
        })),
      function() {
        var e
        ...
        if (
          ((t && !n) ||
            Object.keys(st).forEach(Fe, function(o, i) {
              Yt[o] !== i &&
                void 0 !== i &&
                (n && (st[o] = void 0),
                t || ((r[o] = i), void 0 !== e ? a || e === i || (a = !0) : (e = i)))
            }),
          (r = a ? r : e),
          i)
        )
          for (var s in i) st[s] = i[s]
  ...
  function Ue(e, t) {
    ...
    var n = ur[r] || (ur[r] = new RegExp(or + r + ir, 'g'))
    n.lastIndex = 0
  ...
  function qe(e) {
    return function(t, r, n) {
      e(t, r, n),
        (typeof (r = n.exports) !== 'object' && typeof r !== 'function') ||
          '__esModule' in r ||
  ...
  function ze(e) {
    Qt
      ? e.registerDynamic(Vt ? Qt[0].concat(Vt) : Qt[0], !1, cr ? qe(Qt[1]) : Qt[1])
      : lr && e.registerDynamic([], !1, _)
  }
  function Ne(e, t) {
    !e.load.esModule ||
  ...
  function Je(e, t) {
    var r = this
    var n = this[St]
    return (Be(n, this, e) || Et)
      .then(function() {
        if (!t()) {
          var o = r[jt][e]
          if (e.substr(0, 6) === '@node/') {
            if (!r._nodeRequire)
              throw new TypeError(
                'Error loading ' + e + '. Can only load node core modules in Node.'
              )
            return (
          ...
          return (
            o.load.scriptLoad
              ? (!o.load.pluginKey && fr) ||
                ((o.load.scriptLoad = !1), R.call(n, 'scriptLoad not supported for "' + e + '"'))
              : !1 !== o.load.scriptLoad &&
                !o.load.pluginKey &&
                fr &&
                (o.load.deps ||
                  o.load.globals ||
                  !(
                    o.load.format === 'system' ||
                    o.load.format === 'register' ||
                    (o.load.format === 'global' && o.load.exports)
                  ) ||
                  (o.load.scriptLoad = !0)),
            o.load.scriptLoad
              ? new Promise(function(n, i) {
                  if (o.load.format === 'amd' && st.define !== r.amdDefine)
                    throw new Error(
  ...
  function Be(e, t, r) {
    var n = e.depCache[r]
    if (n) for (a = 0; a < n.length; a++) t.normalize(n[a], r).then(K)
    else {
      var o = !1
      for (var i in e.bundles) {
        for (var a = 0; a < e.bundles[i].length; a++) {
          ...
          if (s.indexOf('*') !== -1) {
            ...
            if (
              r.substr(0, u[0].length) === u[0] &&
              r.substr(r.length - u[1].length, u[1].length) === u[1]
            ) {
              o = !0
              break
            }
          ...
          return r.pluginModule
            ? ((o = !1),
              r.pluginModule.fetch
                ...
                : Kt(r.pluginLoad.address, r.load.authorization, r.load.integrity, !1))
            : Kt(t, r.load.authorization, r.load.integrity, o)
        })
        .then(function(i) {
          return o && typeof i !== 'string'
            ? C(e, i, n).then(function(o) {
                if (!o) {
  ...
  function Ge(e, t, r, n, o) {
    return Promise.resolve(r)
      .then(function(t) {
        return (
          n.load.format === 'detect' && (n.load.format = void 0),
          Ve(t, n),
          n.pluginModule
            ? ((n.pluginLoad.source = t),
              n.pluginModule.translate
                ? Promise.resolve(n.pluginModule.translate.call(e, n.pluginLoad, n.traceOpts)).then(
                    function(e) {
                      if (n.load.sourceMap) {
                        if (typeof n.load.sourceMap !== 'object')
                          throw new Error('metadata.load.sourceMap must be set to an object.')
                        Xe(n.pluginLoad.address, n.load.sourceMap)
                      }
                      return typeof e === 'string' ? e : n.pluginLoad.source
                    }
                  )
                : t)
            : t
      ...
      .then(function(r) {
        return n.load.format || r.substring(0, 8) !== '"bundle"'
          ? n.load.format === 'register' || (!n.load.format && He(r))
            ? ((n.load.format = 'register'), r)
            : n.load.format === 'esm' || (!n.load.format && r.match(gr))
            ? ((n.load.format = 'esm'), Ye(e, r, t, n, o))
            : r
          : ((n.load.format = 'system'), r)
      })
      .then(function(t) {
        if (typeof t !== 'string' || !n.pluginModule || !n.pluginModule.instantiate) return t
        var r = !1
        return (
          (n.pluginLoad.source = t),
          Promise.resolve(
            n.pluginModule.instantiate.call(e, n.pluginLoad, function(e) {
              if (((t = e.source), (n.load = e.metadata), r))
      ...
      .then(function(r) {
        ...
        switch (n.load.format) {
          ...
          case 'cjs':
            var l = n.load.deps
            var c = (n.load.deps || []).concat(n.load.cjsRequireDetection ? Ie(r) : [])
            ...
            e.registerDynamic(c, !0, function(o, i, a) {
              ...
              var u = Ae(a.id)
              var c = { exports: i, args: [o, i, a, u.filename, u.dirname, st, st] }
              var f = '(function (require, exports, module, __filename, __dirname, global, GLOBAL'
              if (n.load.globals)
                for (var d in n.load.globals) c.args.push(o(n.load.globals[d])), (f += ', ' + d)
              var p = st.define
              ;(st.define = void 0),
                (st.__cjsWrapper = c),
                (r =
          ...
          case 'global':
            ...
            e.registerDynamic(c, !1, function(o, i, a) {
              ...
              var f = Re(e, r, n.load.sourceMap, t, n.load.integrity, n.load.nonce, !0)
              if (f) throw f
              var d = c()
              return Ne(n, d), d
            }),
          ...
          default:
            throw new TypeError(
              'Unknown module format "' +
                ...
                t +
                '".' +
                (n.load.format === 'es6' ? ' Use "esm" instead here.' : '')
            )
        }
        if (!i)
          throw new Error(
            'Module ' + t + ' detected as ' + n.load.format + ' but didn\'t execute correctly.'
          )
      })
  }
  function He(e) {
    var t = e.match(hr)
    return t && e.substr(t[0].length, 15) === 'System.register'
  }
  function Ze(e) {
    return e.match(mr)
      ? 'amd'
      : ((vr.lastIndex = 0), (It.lastIndex = 0), It.exec(e) || vr.exec(e) ? 'cjs' : 'global')
  }
  function Xe(e, t) {
    var r = e.split('!')[0]
    ;(t.file && t.file != e) || (t.file = r + '!transpiled'),
      (!t.sources || (t.sources.length <= 1 && (!t.sources[0] || t.sources[0] === e))) &&
        (t.sources = [r])
  }
  function Ye(e, r, n, o, i) {
    ...
    return e.import.call(e, e.transpiler).then(
      function(t) {
        if (!(t = t.__useDefault || t).translate)
          throw new Error(e.transpiler + ' is not a valid transpiler plugin.')
        return t === o.pluginModule
          ? r
          : (typeof o.load.sourceMap === 'string' &&
              (o.load.sourceMap = JSON.parse(o.load.sourceMap)),
            ...
            Promise.resolve(t.translate.call(e, o.pluginLoad, o.traceOpts)).then(function(e) {
              ...
              return (
                t && typeof t === 'object' && Xe(n, t),
                o.load.format === 'esm' && He(e) && (o.load.format = 'register'),
                e
              )
            }))
      },
    ...
    if (r)
      for (var n = r[0].match(wr), o = 0; o < n.length; o++) {
        ...
        if ((i.substr(a - 1, 1) == ';' && a--, s == '"' || '\'' == s)) {
          ...
          var l = u.substr(0, u.indexOf(' '))
          if (l) {
            var c = u.substr(l.length + 1, u.length - l.length - 1)
            l === 'deps' && (l = 'deps[]'),
              l.substr(l.length - 2, 2) === '[]'
  ...
  function et() {
    f.call(this),
      ...
      (this.scriptSrc = dr),
      (this._nodeRequire = er),
      this.registry.set('@empty', Ot),
      tt.call(this, !1, !1),
      Xt(this)
  }
  function tt(e, t) {
    ;(this[St].production = e),
      this.registry.set(
        '@system-env',
        (Er = this.newModule({
          browser: ot,
  ...
  var nt
  var ot = typeof window !== 'undefined' && typeof document !== 'undefined'
  var it = typeof process !== 'undefined' && process.versions && process.versions.node
  var at =
    typeof process !== 'undefined' &&
    typeof process.platform === 'string' &&
    process.platform.match(/^win/)
  var st = typeof self !== 'undefined' ? self : global
  var ut = typeof Symbol !== 'undefined'
  if (typeof document !== 'undefined' && document.getElementsByTagName) {
    if (!(nt = document.baseURI)) {
      var lt = document.getElementsByTagName('base')
      nt = (lt[0] && lt[0].href) || window.location.href
    }
  } else typeof location !== 'undefined' && (nt = location.href)
  if (nt) {
    var ct = (nt = nt.split('#')[0].split('?')[0]).lastIndexOf('/')
    ct !== -1 && (nt = nt.substr(0, ct + 1))
  } else {
  ...
  nt[nt.length - 1] !== '/' && (nt += '/')
  var ft = new Error(0, '_').fileName == '_'
  ...
  var gt = (i.resolveInstantiate = e('resolveInstantiate'))
  ...
  var ht = typeof Symbol !== 'undefined' && Symbol.iterator
  var mt = e('registry')
  ht &&
  ...
  ;(l.prototype = Object.create(null)),
    typeof Symbol !== 'undefined' &&
      Symbol.toStringTag &&
      Object.defineProperty(l.prototype, Symbol.toStringTag, { value: 'Module' })
  ...
  ;(f.prototype[(f.resolve = i.resolve)] = function(e, t) {
    ...
    (f.prototype[bt] = function(e, t) {}),
    (f.prototype[i.resolveInstantiate] = function(e, t) {
      var r = this
      var n = this[yt]
      var o = this.registry[mt]
    ...
    (f.prototype.register = function(e, t, r) {
      ...
      void 0 === r
        ...
        : ((n.records[e] || d(n, e, void 0)).registration = [t, r, void 0])
    }),
    (f.prototype.registerDynamic = function(e, t, r, n) {
      var o = this[yt]
      typeof e !== 'string'
        ? (o.lastRegister = [e, t, r])
        : ((o.records[e] || d(o, e, void 0)).registration = [t, r, n])
    }),
    (x.prototype.import = function(e) {
      return (
        this.loader.trace && this.loader.loads[this.key].dynamicDeps.push(e),
  ...
  var Lt
  var At
  var It = /(?:^\uFEFF?|[^$_a-zA-Z\xA0-\uFFFF."'])require\s*\(\s*("[^"\\]*(?:\\.[^"\\]*)*"|'[^'\\]*(?:\\.[^'\\]*)*'|`[^`\\]*(?:\\.[^`\\]*)*`)\s*\)/g
  var Ft = typeof XMLHttpRequest !== 'undefined'
  var Kt = (At =
    typeof self !== 'undefined' && void 0 !== self.fetch
      ? J
      : Ft
      ? $
      ...
      : W)
  var Dt = {}
  var Ut = ['browser', 'node', 'dev', 'build', 'production', 'default']
  var qt = /#\{[^\}]+\}/
  var Tt = ['browserConfig', 'nodeConfig', 'devConfig', 'buildConfig', 'productionConfig']
  var zt = typeof Buffer !== 'undefined'
  try {
    zt && new Buffer('a').toString('base64') !== 'YQ==' && (zt = !1)
  } catch (e) {
    zt = !1
  }
  var Nt
  ...
  var Xt = function(e) {
    function t(r, n, o, i) {
      ...
      if ((typeof r === 'string' && typeof n === 'function' && (r = [r]), !(r instanceof Array))) {
        if (typeof r === 'string') {
      ...
      function i(r, i, l) {
        ...
        if (
          ...
          var d = function(n, o, i) {
            return typeof n === 'string' && typeof o !== 'function'
              ? r(n)
              : t.call(e, n, o, i, l.id)
          }
          ;(d.toUrl = function(t) {
        ...
        var p = st.require
        st.require = t
        var g = o.apply(s === -1 ? st : i, c)
        ;(st.require = p), void 0 !== g && (l.exports = g)
      }
      typeof r !== 'string' && ((o = n), (n = r), (r = null)),
        n instanceof Array || ((o = n), (n = ['require', 'exports', 'module'].splice(0, o.length))),
        typeof o !== 'function' &&
          (o = (function(e) {
            return function() {
              return e
        ...
        r || (Vt && ((n = n.concat(Vt)), (Vt = void 0)))
      var a, s, u
      ;(a = n.indexOf('require')) !== -1 &&
        (n.splice(a, 1), r || (n = n.concat(Ue(o.toString(), a)))),
        (s = n.indexOf('exports')) !== -1 && n.splice(s, 1),
        (u = n.indexOf('module')) !== -1 && n.splice(u, 1),
        r
          ? (e.registerDynamic(r, n, !1, i), Qt ? ((Qt = void 0), (lr = !0)) : lr || (Qt = [n, i]))
          : e.registerDynamic(n, !1, cr ? qe(i) : i)
    }
    e.set('@@cjs-helpers', e.newModule({ requireResolve: Le.bind(e), getPathVars: Ae })),
      e.set('@@global-helpers', e.newModule({ prepareGlobal: De })),
      (r.amd = {}),
      (e.amdDefine = r),
      (e.amdRequire = t)
  }
  typeof window !== 'undefined' &&
    typeof document !== 'undefined' &&
    window.location &&
    (Zt = location.protocol + '//' + location.hostname + (location.port ? ':' + location.port : ''))
  var Yt
  var Qt
  var Vt
  var er
  ...
  typeof require === 'undefined' ||
    ...
    (er = require)
  var dr
  var pr = typeof self !== 'undefined' ? 'self' : 'global'
  var gr = /(^\s*|[}\);\n]\s*)(import\s*(['"]|(\*\s+as\s+)?(?!type)([^"'\(\)\n; ]+)\s*from\s*['"]|\{)|export\s+\*\s+from\s+["']|export\s*(\{|default|function|class|var|const|let|async\s+function))/
  var hr = /^(\s*\/\*[^\*]*(\*(?!\/)[^\*]*)*\*\/|\s*\/\/[^\n]*|\s*"[^"]+"\s*;?|\s*'[^']+'\s*;?)*\s*/
  var mr = /(?:^\uFEFF?|[^$_a-zA-Z\xA0-\uFFFF.])define\s*\(\s*("[^"]+"\s*,\s*|'[^']+'\s*,\s*)?\s*(\[(\s*(("[^"]+"|'[^']+')\s*,|\/\/.*\r?\n|\/\*(.|\s)*?\*\/))*(\s*("[^"]+"|'[^']+')\s*,?)?(\s*(\/\/.*\r?\n|\/\*(.|\s)*?\*\/))*\s*\]|function\s*|{|[_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*\))/
  var vr = /(?:^\uFEFF?|[^$_a-zA-Z\xA0-\uFFFF.])(exports\s*(\[['"]|\.)|module(\.exports|\['exports'\]|\["exports"\])\s*(\[['"]|[=,\.]))/
  var yr = /^\#\!.*/
  var br = /^(\s*\/\*[^\*]*(\*(?!\/)[^\*]*)*\*\/|\s*\/\/[^\n]*|\s*"[^"]+"\s*;?|\s*'[^']+'\s*;?)+/
  var wr = /\/\*[^\*]*(\*(?!\/)[^\*]*)*\*\/|\/\/[^\n]*|"[^"]+"\s*;?|'[^']+'\s*;?/g
  ...
  else typeof __filename !== 'undefined' && (dr = __filename)
  var Er
  ;(et.prototype = Object.create(f.prototype)),
    (et.prototype.constructor = et),
    (et.prototype[(et.resolve = f.resolve)] = et.prototype.normalize = Z),
    ...
    (et.prototype[(et.instantiate = f.instantiate)] = Je),
    (et.prototype.config = ke),
    (et.prototype.getConfig = xe),
    (et.prototype.global = st),
    (et.prototype.import = function() {
  ...
  ;(et.prototype.delete = function(e) {
    ...
    (et.prototype.isModule = M),
    (et.prototype.register = function(e, t, r) {
      return (
        typeof e === 'string' && (e = X.call(this, this[St], e)),
        f.prototype.register.call(this, e, t, r)
      )
    }),
    (et.prototype.registerDynamic = function(e, t, r, n) {
      return (
        typeof e === 'string' && (e = X.call(this, this[St], e)),
        f.prototype.registerDynamic.call(this, e, t, r, n)
      )
    }),
    (et.prototype.version = '0.20.19 Dev')
  var _r = new et()
  ;(ot || _t) && (st.SystemJS = st.System = _r),
    typeof module !== 'undefined' && module.exports && (module.exports = _r)
})()
